...
use Tomeet\Modules\Exceptions\InvalidAssetPath;
use Tomeet\Modules\Exceptions\ModuleNotFoundException;
use Tomeet\Modules\Process\Installer;
use Tomeet\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \Tomeet\Modules\Exceptions\ModuleNotFoundException
     */
